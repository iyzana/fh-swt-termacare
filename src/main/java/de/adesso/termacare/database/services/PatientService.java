...
import de.adesso.termacare.database.construct.AbstractService;
 ...
 */
public class PatientService extends AbstractService<PatientRepo, Patient, Integer> {
